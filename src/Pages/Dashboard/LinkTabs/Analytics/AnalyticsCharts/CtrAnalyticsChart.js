...
import img from '../../../../../assets/icons/analytics-tab-icons/ctr.svg'

const CtrAnalyticsChart = () => {
    const [ctrChart, setCtrChart] = useState({
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 w-full'>
            <div className='grid grid-cols-1 gap-2' >
                <h1 className='text-gray-500 font-semibold px-4'>CTR</h1>
                <div id="chart" className='w-full relative' >
                    <ReactApexChart options={ctrChart.options} series={ctrChart.series} type="area" height={350} width={500} />
                    <div className='w-24 h-8 rounded-md border flex justify-between items-center shadow px-2 absolute top-5 right-0 md:-right-40 bg-white' >
